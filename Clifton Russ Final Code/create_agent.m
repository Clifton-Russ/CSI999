...
% malicious actors
%%
function [people] = create_agent(start, stop,threat_size)
...
%xmin=.65; % the compliance floor score
%xmax=.75; % the compliance ceiling  score
...
compliance_score = xmin + (xmax-xmin).*rand(1,1);
    ...
    %determine_agent_threat(people{i,2},vuln_size);
end
