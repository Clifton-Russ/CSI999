function [click_percent_step_mean,report_rate, markov, transition_matrix, e_thresholds_daily,vuln_controls, incident_input, vuln_breach, vuln_incident_total] = create_suborganization2(a_size_total, days, agent_compliance_average,incident_threshold, phish_report_rate, scenario)
% This second version has more output variables that can be used in
% Scenario 3.
...
vuln_breach_total = cell(a_size,days);
    for i = 1:a_size
        for j = 1: days
             ...
             % individual scores
             if scenario == "1d2"
                agent_compliance_average = [.7, .7, .7, .7];
