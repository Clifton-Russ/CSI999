function [c_family_incident, vuln_scores, c_family_input] = determine_state_vuln6(agent_compliance_average, mc_baseline,e_thresholds_daily,vuln_idx)
...
for i = 1:mc_size
    ...
    if mc_baseline(i,1) == 1 
        ...
        [c_family_incident{i,1},c_family_input{i,1}] = determine_incident(agent_compliance_average,e_thresholds_daily{1,1}(1,:));
    ...
    elseif mc_baseline(i,1) == 2 %
         ...
         [c_family_incident{i,2}, c_family_input{i,2}] = determine_incident(agent_compliance_average,e_thresholds_daily{2,1}(1,:));
    ...
    elseif mc_baseline(i,1) == 3 
        ...
        [c_family_incident{i,3}, c_family_input{i,3}] = determine_incident(agent_compliance_average,e_thresholds_daily{3,1}(1,:));
    ...
    elseif mc_baseline(i,1) == 4 % 
        ...
        [c_family_incident{i,4}, c_family_input{i,4}] = determine_incident(agent_compliance_average,e_thresholds_daily{4,1}(1,:));
