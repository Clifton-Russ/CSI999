function [click_percent_step_mean,click_percent_step] = determine_daily_click_rate(a_size_total, days, agent_compliance_average,incident_threshold, phish_report_rate, scenario)
