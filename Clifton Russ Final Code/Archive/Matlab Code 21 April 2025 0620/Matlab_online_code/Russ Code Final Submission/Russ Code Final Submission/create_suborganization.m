function [click_percent_step_mean,report_rate, vuln_incident_total] = create_suborganization(a_size_total, days, agent_compliance_average,incident_threshold, phish_report_rate, scenario)
