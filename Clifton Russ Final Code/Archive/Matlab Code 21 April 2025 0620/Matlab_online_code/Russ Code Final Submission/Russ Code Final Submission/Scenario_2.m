...
%% calculate the checked email reduction (Team 1)
%mean(c_email_reduction,"all");
mean(c_email_reduction,1);
...
c_email_reduction = (c_email_old - c_email_new)./c_email_old;
%% Calculates the average reduction
% This calculates the average reduction of checked emails due to Team 4
% reporting emails. 

temp = mean(c_email_reduction,1);

% This saves the reduction for team 2
team_2_reduction(1,4) = temp(1,2);
